...
<template>
  ...
  <form class="formulario">
    <fieldset>
        ...
        <label class="fieldForm">Correo electr&oacute;nico:
        ...
        <label class="fieldForm">Contraseña:
        ...
        <label class="fieldForm">Fecha de nacimiento:
  ...
  <!--Creo botones en vez de inputs submit y reset para usar los metodos:
        * crear, que simula que se grabo bien y borra los campos
        * limpiar. que limpia los campos
      Porque con submit y reset se limpian automaticamente los campos-->
  <button class="boton" @click="crearUsuario">Crear usuario</button>
  <button class="boton" @click="limpiarFormulario">Limpiar formulario</button>
